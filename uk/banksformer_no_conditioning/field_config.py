...
cat_code_fields = ['description', 'flag', 'type'] # not used in network! only for creating tcode with correct 
TCODE_SEP = "__"
...
def get_field_info(ds_suffix, store_d = False):
    ...
    if store_d:
        ...
        vals = {'CAT_FIELDS': CAT_FIELDS,
'DATE_FIELDS': DATE_FIELDS,
'CONT_FIELDS': CONT_FIELDS,
'DATA_KEY_ORDER': DATA_KEY_ORDER,
'NON_OUT_FIELDS': NON_OUT_FIELDS,
'LOSS_TYPES': LOSS_TYPES,
'INP_ENCODINGS': INP_ENCODINGS,
'TAR_ENCODINGS': TAR_ENCODINGS,
'CLOCK_DIMS': CLOCK_DIMS,
'FIELD_DIMS_IN': FIELD_DIMS_IN,
'FIELD_DIMS_TAR': FIELD_DIMS_TAR,
'FIELD_DIMS_NET': FIELD_DIMS_NET,
'FIELD_DIMS_IN': FIELD_DIMS_IN,
'FIELD_STARTS_IN': FIELD_STARTS_IN,
'FIELD_DIMS_TAR': FIELD_DIMS_TAR,
'FIELD_STARTS_TAR': FIELD_STARTS_TAR,
'FIELD_DIMS_NET': FIELD_DIMS_NET,
'FIELD_STARTS_NET': FIELD_STARTS_NET,
'ENCODING_INP_DIMS_BY_TYPE': ENCODING_INP_DIMS_BY_TYPE,
'ENCODING_TAR_DIMS_BY_TYPE': ENCODING_TAR_DIMS_BY_TYPE,}
            
        with open(f"stored_data/store_d-{ds_suffix}.pickle", "wb") as f:
            pickle.dump(vals, f) 
